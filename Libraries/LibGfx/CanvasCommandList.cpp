...
template<>
ErrorOr<void> encode(Encoder& encoder, Gfx::CanvasCommands::Initialize const& command)
{
...
template<>
ErrorOr<Gfx::CanvasCommands::Initialize> decode(Decoder& decoder)
{
    return Gfx::CanvasCommands::Initialize {
