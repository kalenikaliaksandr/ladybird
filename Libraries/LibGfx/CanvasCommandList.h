...
struct Initialize {
    IntSize size;
    BitmapFormat format { BitmapFormat::BGRA8888 };
...
template<>
ErrorOr<void> encode(Encoder&, Gfx::CanvasCommands::Initialize const&);
template<>
ErrorOr<Gfx::CanvasCommands::Initialize> decode(Decoder&);
