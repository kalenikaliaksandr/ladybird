    ...
    if (png_get_acTL(png_ptr, info_ptr, &frame_count, &loop_count)) {
        ...
        for (size_t frame_index = 0; frame_index < frame_count; ++frame_index) {
            ...
            case PNG_BLEND_OP_SOURCE:
                ...
                painter->draw_bitmap(frame_rect, *decoded_frame_bitmap, decoded_frame_bitmap->rect(), Gfx::ScalingMode::NearestNeighbor, {}, 1.0f, Gfx::CompositingAndBlendingOperator::Copy);
                break;
            case PNG_BLEND_OP_OVER:
                ...
                painter->draw_bitmap(frame_rect, *decoded_frame_bitmap, decoded_frame_bitmap->rect(), ScalingMode::NearestNeighbor, {}, 1.0f, Gfx::CompositingAndBlendingOperator::SourceOver);
                break;
            default:
                VERIFY_NOT_REACHED();
            }
            ...
            case PNG_DISPOSE_OP_PREVIOUS:
                ...
                painter->draw_bitmap(frame_rect, *prev_output_buffer, IntRect { x, y, width, height }, Gfx::ScalingMode::NearestNeighbor, {}, 1.0f, Gfx::CompositingAndBlendingOperator::Copy);
                break;
            default:
                VERIFY_NOT_REACHED();
            }
