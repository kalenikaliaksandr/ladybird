...
public:
    ...
    void draw_painting_surface(Gfx::FloatRect const& dst_rect, Gfx::PaintingSurface const&, Gfx::IntRect const& src_rect, Gfx::ScalingMode, Optional<Gfx::Filter>, float global_alpha, Gfx::CompositingAndBlendingOperator compositing_and_blending_operator);
