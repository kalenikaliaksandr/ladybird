...
DecoderErrorOr<void> Reader::parse_initial_data()
{
    ...
    dbgln_if(MATROSKA_TRACE_DEBUG, "Segment is at {} with size {}, available size is {}", m_segment_contents_position, m_segment_contents_size, m_stream_cursor->expected_size() - m_segment_contents_position);
    return {};
}
