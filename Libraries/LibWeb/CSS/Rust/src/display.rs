...
/// Pure type definitions for Rust-owned computed-value payloads.
///
/// This module contains no lifecycle behavior or exported functions so crates
/// which consume the immutable payload bytes can share these definitions
/// directly.
