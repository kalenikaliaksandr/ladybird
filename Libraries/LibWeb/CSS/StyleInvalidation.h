...
struct RequiredInvalidationAfterStyleChange {
    ...
    [[nodiscard]] bool is_none() const { return !repaint && !rebuild_stacking_context_tree && !relayout && !rebuild_layout_tree && !rebuild_accumulated_visual_contexts && !refresh_accumulated_visual_contexts; }
