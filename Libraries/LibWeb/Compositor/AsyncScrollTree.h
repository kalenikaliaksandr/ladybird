...
private:
    ...
    AsyncStickyArea const* sticky_area_for_scroll_node_index(Painting::ScrollNodeIndex) const;
    ...
    Gfx::FloatPoint cumulative_device_sticky_offset_for_node(Painting::ScrollNodeIndex, Painting::ScrollStateSnapshot const&) const;
