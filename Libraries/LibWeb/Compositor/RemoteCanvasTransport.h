...
public:
    ...
    // The Compositor allocates the context's backing surface from these parameters;
    // they are fixed for the context's lifetime (a canvas resize destroys and
    // recreates the context).
    virtual bool create_context(Painting::CanvasContextId, Gfx::IntSize, bool alpha) = 0;
