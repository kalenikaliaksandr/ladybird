...
public:
    ...
    void schedule_accumulated_visual_context_subtree_reconcile(Element&);
    void schedule_accumulated_visual_context_subtree_reconcile(Layout::Node const&);
...
private:
    ...
    Vector<WeakPtr<Painting::Paintable>> m_paintable_subtrees_needing_visual_context_reconcile;
