...
public:
    ...
    [[nodiscard]] bool layout_tree_dirt_escapes_partial_relayout_boundaries() const { return m_layout_tree_dirt_escapes_partial_relayout_boundaries; }
    void set_layout_tree_dirt_escapes_partial_relayout_boundaries(bool, char const* reason);
...
private:
    ...
    bool m_layout_tree_dirt_escapes_partial_relayout_boundaries { false };
