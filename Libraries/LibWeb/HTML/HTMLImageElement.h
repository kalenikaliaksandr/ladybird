...
public:
    ...
    virtual RefPtr<Gfx::Bitmap const> default_image_bitmap_sized(Gfx::IntSize) const override;
    ...
    virtual RefPtr<Gfx::Bitmap const> current_image_bitmap_sized(Gfx::IntSize) const override;
