        ...
        [&](CanvasImageSource const& image_source) {
            image_source.visit(
                ...
                [&](auto const& image_element) {
                    ...
                    RefPtr<Gfx::Bitmap const> source_bitmap;
                    if (has_natural_dimensions) {
                        source_bitmap = image_element->default_image_bitmap_sized(Gfx::IntSize { *image_element->intrinsic_width(), *image_element->intrinsic_height() });
                    } else {
                        source_bitmap = image_element->default_image_bitmap_sized(Gfx::IntSize { *options->resize_width, *options->resize_height });
                    }
