...
public:
    ...
    virtual RefPtr<Gfx::Bitmap const> current_image_bitmap() const;
    virtual RefPtr<Gfx::Bitmap const> current_image_bitmap_sized(Gfx::IntSize) const = 0;

    virtual RefPtr<Gfx::Bitmap const> default_image_bitmap() const;
    virtual RefPtr<Gfx::Bitmap const> default_image_bitmap_sized(Gfx::IntSize) const;
