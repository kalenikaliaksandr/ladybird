...
public:
    ...
    InlineLevelIterator(Layout::InlineFormattingContext&, Layout::BlockContainer const& containing_block, LayoutState::UsedValues const& containing_block_used_values, LayoutMode);
