...
RustFFI::FfiCommitSink LayoutRustBridge::commit_sink()
{
    return {
        .context = this,
        .content_size_changed = [](void*, void* layout_node_shell, bool row_existed_before_this_commit, RustFFI::FfiCssPixelSize old_size, RustFFI::FfiCssPixelSize new_size) {
