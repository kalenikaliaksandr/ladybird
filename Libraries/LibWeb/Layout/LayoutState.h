...
struct LayoutState {
    ...
    // taking the paintable to replace splices the rebuilt paint subtree at that paintable's
    // position among its siblings; the plain overload replaces the root's own paintable in
