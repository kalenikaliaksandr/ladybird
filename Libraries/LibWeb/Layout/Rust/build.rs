...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    layout_config.export.include = vec![
        ...
        "FfiGridTrackBreadth".to_string(),
        "FfiGridTrackList".to_string(),
        "FfiGridTrackEntry".to_string(),
        "FfiGridArea".to_string(),
        "FfiGridPlacementKind".to_string(),
        "FfiGridPlacement".to_string(),
        "FfiGridStyleFacts".to_string(),
        "FfiGridLayoutLine".to_string(),
        "FfiGridLayoutTrack".to_string(),
        "FfiGridLayoutDimension".to_string(),
        "FfiGridLayoutArea".to_string(),
        "FfiGridLayoutFragment".to_string(),
        "FfiGridLayoutData".to_string(),
        "FfiUsedGridLine".to_string(),
        "FfiUsedGridTrackList".to_string(),
    ...
    generate_ffi_header(
        ...
        &[
            ...
            manifest_dir.join("src/fc/grid/facts.rs"),
        ],
        &out_dir,
        &ffi_out_dir,
