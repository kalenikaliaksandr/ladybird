...
pub(crate) struct UsedValuesCore {
    ...
    pub inline_size_constraint: Cell<FfiSizeConstraint>,
    pub block_size_constraint: Cell<FfiSizeConstraint>,
    ...
    pub containing_line_box_fragment: Cell<FfiLineBoxFragmentCoordinate>,
}
...
impl Default for UsedValuesCore {
    fn default() -> Self {
        ...
        Self {
            ...
            inline_size_constraint: Cell::new(FfiSizeConstraint::None),
            block_size_constraint: Cell::new(FfiSizeConstraint::None),
            ...
            containing_line_box_fragment: Cell::new(FfiLineBoxFragmentCoordinate::default()),
        }
    }
}
...
impl UsedValuesCore {
    pub(crate) fn has_definite_inline_size(&self) -> bool {
        self.has_definite_inline_size.get() && self.inline_size_constraint.get() == FfiSizeConstraint::None
    }

    pub(crate) fn has_definite_block_size(&self) -> bool {
        self.has_definite_block_size.get() && self.block_size_constraint.get() == FfiSizeConstraint::None
    }
    ...
    pub(crate) fn available_inner_space_or_constraints_from(
        ...
        let mut inline_size = match self.inline_size_constraint.get() {
            ...
            FfiSizeConstraint::None if self.has_definite_inline_size.get() => {
        ...
        let mut block_size = match self.block_size_constraint.get() {
            FfiSizeConstraint::MinContent => AvailableSize::min_content(),
            FfiSizeConstraint::MaxContent => AvailableSize::max_content(),
            FfiSizeConstraint::None if self.has_definite_block_size.get() => {
