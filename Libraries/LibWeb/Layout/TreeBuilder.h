...
private:
    ...
    void create_layout_tree(DOM::Node&, Context&, CSS::StyleComputer&);
    ...
    void create_pseudo_element_if_needed(DOM::Element&, CSS::StyleComputer&, CSS::Selector::PseudoElement::Type, AppendOrPrepend);
