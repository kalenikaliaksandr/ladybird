...
struct DisplayListCommandHeader {
    ...
    u32 payload_size { 0 };
    // Inspector overlays record { spatial, 0, 0 }: they track the highlighted element's transforms
    // and scroll offsets but must not be clipped or faded by its ancestors.
