...
DisplayListCommandRange DisplayListRecorder::append_cached_command_range(DisplayList const& source_display_list, DisplayListCommandRange source_range, VisualContextRefs recorded_context_refs)
{
    auto destination_offset = m_display_list.append_command_range_from(
        source_display_list,
        source_range,
        m_visual_context_tree,
        recorded_context_refs,
