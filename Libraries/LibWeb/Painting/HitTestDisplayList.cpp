...
void HitTestDisplayList::dump(StringBuilder& builder) const
{
    if (!is_current()) {
        builder.append("(stale hit-test display list)\n"sv);
        return;
    }
    Painting::dump_hit_test_display_list(builder, *m_arena);
}
