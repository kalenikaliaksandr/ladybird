...
Layout::RustFFI::FfiDumpCallbacks dump_callbacks(StringBuilder& output)
{
    return {
        .context = &output,
        .describe_layout_node = [](void*, void* node_shell, void* output_string) {
            auto description = static_cast<Layout::Node const*>(node_shell)->debug_description();
            Layout::RustFFI::layout_arena_dump_append_string(output_string, description.bytes().data(), description.bytes().size()); },
        .describe_dom_node = [](void*, void* node_shell, void* output_string) -> bool {
            auto const* dom_node = static_cast<Layout::Node const*>(node_shell)->dom_node();
            if (!dom_node)
                return false;
            auto description = dom_node->debug_description().to_utf8();
            Layout::RustFFI::layout_arena_dump_append_string(output_string, description.bytes().data(), description.bytes().size());
            return true;
        },
        .append_output = [](void* context, u8 const* bytes, size_t length) { static_cast<StringBuilder*>(context)->append(StringView { bytes, length }); },
    };
}
...
static CSS::AbstractImageStyleValue const* layer_image_for(Paintable const& paintable, u8 list, u32 computed_index)
{
...
void dump_visual_context_tree(StringBuilder& builder, ViewportPaintable const& viewport_paintable)
{
    Layout::RustFFI::layout_arena_dump_visual_context_tree(viewport_paintable.rust_arena().handle(), viewport_paintable.rust_slot(), dump_callbacks(builder));
}
...
Layout::RustFFI::FfiPaintHostCallbacks paint_host_callbacks(PaintHostContext& context)
{
    return {
        ...
        .image_intrinsic_facts = [](void*, void* paintable_shell, u8 list, u32 computed_index) -> Layout::RustFFI::FfiImageIntrinsicFacts {
            auto const& paintable = *static_cast<Paintable const*>(paintable_shell);
        ...
        .layer_image_prepare = [](void*, void* paintable_shell, u8 list, u32 computed_index) -> Layout::RustFFI::FfiLayerImagePrepareFacts {
            auto const& paintable = *static_cast<Paintable const*>(paintable_shell);
        ...
        .layer_image_nested_display_list = [](void* context_pointer, void* paintable_shell, u8 list, u32 computed_index, i32 const* dest) -> Layout::RustFFI::FfiLayerImageNestedDisplayListFacts {
            auto& context = *static_cast<PaintHostContext*>(context_pointer);
            auto const& paintable = *static_cast<Paintable const*>(paintable_shell);
        ...
        .layer_image_current_frame = [](void* context_pointer, void* paintable_shell, u8 list, u32 computed_index, i32 const* dest) -> Layout::RustFFI::FfiLayerImageFrameFacts {
            auto& context = *static_cast<PaintHostContext*>(context_pointer);
            auto const& paintable = *static_cast<Paintable const*>(paintable_shell);
        ...
        .layer_image_paint = [](void* context_pointer, void* paintable_shell, u8 list, u32 computed_index, float const* dest, i32 const* css_size_raw, u8 image_rendering_raw, float const* accumulated_scale_raw) -> Layout::RustFFI::FfiImagePaintFacts {
            auto& context = *static_cast<PaintHostContext*>(context_pointer);
            auto const& paintable = *static_cast<Paintable const*>(paintable_shell);
            auto const& layout_node = paintable.layout_node();
        ...
        .replaced_paint_facts = [](void* context_pointer, void* paintable_shell) -> Layout::RustFFI::FfiReplacedPaintFacts {
            ...
            if (is<ImagePaintable>(paintable)) {
                auto const& image_provider = static_cast<ImagePaintable const&>(paintable).image_provider();
            ...
            } else if (is<CanvasPaintable>(paintable)) {
            ...
            } else if (is<VideoPaintable>(paintable)) {
                ...
                case HTML::HTMLVideoElement::Representation::TransparentBlack:
                    facts.video_representation = 2;
                    break;
                }
            } else if (is<NavigableContainerViewportPaintable>(paintable)) {
                auto const& navigable_container = static_cast<NavigableContainerViewportPaintable const&>(paintable).navigable_container();
            ...
            } else if (is<CheckBoxPaintable>(paintable) || is<RadioButtonPaintable>(paintable)) {
        ...
        .replaced_image_paint = [](void* context_pointer, void* paintable_shell, float const* dest, float const* accumulated_scale_raw) -> Layout::RustFFI::FfiImagePaintFacts {
            ...
            if (auto const* image_paintable = as_if<ImagePaintable>(paintable))
                decoded_image_data = image_paintable->image_provider().decoded_image_data();
        ...
        .svg_paint_style = [](void* context_pointer, void* paintable_shell, bool is_stroke, Layout::RustFFI::FfiSvgPaintContext const* ffi_paint_context, void* sink) -> Layout::RustFFI::FfiSvgPaintStyle {
            ...
            auto write_gradient = [&](GradientPaintStyle const& gradient) {
                ...
                style.spread_method = to_underlying(gradient.spread_method());
...
void dump_hit_test_display_list(StringBuilder& builder, Layout::NodeArena& arena)
{
    Layout::RustFFI::layout_arena_dump_hit_test_display_list(arena.handle(), dump_callbacks(builder));
}
