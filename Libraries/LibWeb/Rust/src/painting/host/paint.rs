...
pub const IMAGE_LIST_BACKGROUND: u8 = 0;
pub const IMAGE_LIST_MASK: u8 = 1;
pub const IMAGE_LIST_BORDER_IMAGE_SOURCE: u8 = 2;
pub const IMAGE_LIST_DOCUMENT_BACKGROUND: u8 = 3;
...
pub struct FfiPaintHostCallbacks {
    ...
    pub image_intrinsic_facts: unsafe extern "C" fn(*mut c_void, *mut c_void, u8, u32) -> FfiImageIntrinsicFacts,
    ...
    pub layer_image_prepare: unsafe extern "C" fn(*mut c_void, *mut c_void, u8, u32) -> FfiLayerImagePrepareFacts,
    pub layer_image_nested_display_list:
        unsafe extern "C" fn(*mut c_void, *mut c_void, u8, u32, *const i32) -> FfiLayerImageNestedDisplayListFacts,
    pub layer_image_current_frame:
        unsafe extern "C" fn(*mut c_void, *mut c_void, u8, u32, *const i32) -> FfiLayerImageFrameFacts,
