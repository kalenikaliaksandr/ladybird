...
use crate::painting::host::FfiSvgPaintStyle;
...
fn svg_paint_facts(recorder: &mut PaintRecorder<'_>, paintable: PaintableSlotId) -> (SvgPaintFacts, Vec<f32>) {
    ...
    facts.cap_style = match svg.stroke_linecap {
        stroke_linecap::ROUND => 1,
        stroke_linecap::SQUARE => 2,
        _ => 0,
    };
    facts.join_style = match svg.stroke_linejoin {
        stroke_linejoin::ROUND => 1,
        stroke_linejoin::BEVEL => 2,
        _ => 0,
    };
...
fn paint_style_from_ffi(
    ...
    let spread_method = match style.spread_method {
        1 => DisplayListGradientSpreadMethod::Repeat,
        2 => DisplayListGradientSpreadMethod::Reflect,
        _ => DisplayListGradientSpreadMethod::Pad,
    };
    ...
    match style.kind {
        1 => Some(PaintStyle::LinearGradient {
            gradient_transform,
            spread_method,
            color_space,
            color_stops,
        ...
        2 => Some(PaintStyle::RadialGradient {
            gradient_transform,
            spread_method,
            color_space,
            color_stops,
...
pub(crate) fn paint_path(recorder: &mut PaintRecorder<'_>, paintable: PaintableSlotId, phase: PaintPhase) {
    ...
    for index in 0..facts.paint_order_count as usize {
        match facts.paint_order[index] {
            ...
            paint_order::STROKE => {
                let cap_style = match facts.cap_style {
                    1 => CapStyle::Round,
                    2 => CapStyle::Square,
                    _ => CapStyle::Butt,
                };
                let join_style = match facts.join_style {
                    1 => JoinStyle::Round,
                    2 => JoinStyle::Bevel,
                    _ => JoinStyle::Miter,
                };
