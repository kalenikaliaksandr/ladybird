...
protected:
    ...
    // A texture image source resolved for upload: the image's shared-memory frame plus
    // the unpack state the host must apply while converting the pixels next to GL.
