...
public:
    ...
    void bind_texture(WebIDL::UnsignedLong target, GC::Ptr<WebGLTexture> texture);
    ...
    void delete_program(GC::Ptr<WebGLProgram> program);
    void delete_renderbuffer(GC::Ptr<WebGLRenderbuffer> renderbuffer);
    void delete_shader(GC::Ptr<WebGLShader> shader);
    void delete_texture(GC::Ptr<WebGLTexture> texture);
    void depth_func(WebIDL::UnsignedLong func);
    void depth_mask(bool flag);
    void depth_range(float z_near, float z_far);
    void detach_shader(GC::Ref<WebGLProgram> program, GC::Ref<WebGLShader> shader);
    ...
    void finish();
    void flush();
    void framebuffer_renderbuffer(WebIDL::UnsignedLong target, WebIDL::UnsignedLong attachment, WebIDL::UnsignedLong renderbuffertarget, GC::Ptr<WebGLRenderbuffer> renderbuffer);
    void framebuffer_texture2d(WebIDL::UnsignedLong target, WebIDL::UnsignedLong attachment, WebIDL::UnsignedLong textarget, GC::Ptr<WebGLTexture> texture, WebIDL::Long level);
    ...
    bool is_framebuffer(GC::Ptr<WebGLFramebuffer> framebuffer);
    bool is_program(GC::Ptr<WebGLProgram> program);
    bool is_renderbuffer(GC::Ptr<WebGLRenderbuffer> renderbuffer);
    bool is_shader(GC::Ptr<WebGLShader> shader);
    bool is_texture(GC::Ptr<WebGLTexture> texture);
    void line_width(float width);
    void link_program(GC::Ref<WebGLProgram> program);
    ...
    void uniform1f(GC::Ptr<WebGLUniformLocation> location, float x);
    void uniform2f(GC::Ptr<WebGLUniformLocation> location, float x, float y);
    void uniform3f(GC::Ptr<WebGLUniformLocation> location, float x, float y, float z);
    void uniform4f(GC::Ptr<WebGLUniformLocation> location, float x, float y, float z, float w);
    void uniform1i(GC::Ptr<WebGLUniformLocation> location, WebIDL::Long x);
    void uniform2i(GC::Ptr<WebGLUniformLocation> location, WebIDL::Long x, WebIDL::Long y);
    void uniform3i(GC::Ptr<WebGLUniformLocation> location, WebIDL::Long x, WebIDL::Long y, WebIDL::Long z);
    void uniform4i(GC::Ptr<WebGLUniformLocation> location, WebIDL::Long x, WebIDL::Long y, WebIDL::Long z, WebIDL::Long w);
    void use_program(GC::Ptr<WebGLProgram> program);
    void validate_program(GC::Ref<WebGLProgram> program);
