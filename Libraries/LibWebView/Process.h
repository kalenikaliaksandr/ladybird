...
public:
    ...
    static void register_pending_ipc_ports(pid_t pid, Core::MachPort receive_right, Core::MachPort send_right);
    static Optional<PendingIPCPorts> take_pending_ipc_ports(pid_t pid);
    static void send_ipc_ports_to_child(Core::MachPort& reply_port, Core::MachPort receive_right, Core::MachPort send_right);
#endif
