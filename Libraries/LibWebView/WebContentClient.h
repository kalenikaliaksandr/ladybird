...
private:
    ...
    virtual void did_append_session_history_entry(u64 page_id, u64 navigable_id, WebView::UISessionHistoryEntry entry) override;
    virtual void did_replace_session_history_entry(u64 page_id, u64 navigable_id, WebView::UISessionHistoryEntry entry) override;
