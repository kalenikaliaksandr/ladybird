...
public:
    ...
    virtual void did_request_cursor_change(Web::Compositor::CompositorContextId, Gfx::Cursor const&) = 0;
};
...
public:
    ...
    virtual void forward_mouse_event(u64 page_id, Web::MouseEvent const&) = 0;
...
public:
    ...
    enum class SetWebContentClientResult {
        Accepted,
        ContextDestroyed,
        ConflictingOwner,
    };
    ...
    SetWebContentClientResult set_web_content_client_for_context(Web::Compositor::CompositorContextId, CompositorStateWebContentClient&);
    void destroy_contexts_for_web_content_client(CompositorStateWebContentClient&);

    void create_context(Web::Compositor::CompositorContextId, Optional<u64> page_id, Web::Compositor::PagePresentationRegistration);
    ...
    void did_request_cursor_change(Web::Compositor::CompositorContextId, Gfx::Cursor const&);
    bool mouse_event(Web::Compositor::CompositorContextId, Web::MouseEvent const&);
    void forward_mouse_event(Web::Compositor::CompositorContextId, Web::MouseEvent const&);
    ...
    void device_pixels_per_css_pixel_updated(Web::Compositor::CompositorContextId, double);
    void system_visibility_state_updated(Web::Compositor::CompositorContextId, Web::HTML::VisibilityState);
    void window_occlusion_state_updated(Web::Compositor::CompositorContextId, bool is_occluded);
...
private:
    ...
    ContextState& ensure_context(Web::Compositor::CompositorContextId);
    ...
    Optional<Web::Compositor::CompositorContextState::ViewportScrollbarDrag> begin_viewport_scrollbar_drag(ContextState&, Gfx::FloatPoint position);
    Optional<Web::Compositor::CompositorContextState::ViewportScrollbarDrag> captured_viewport_scrollbar_drag(ContextState&, Gfx::FloatPoint position);
    Optional<Web::Compositor::CompositorContextState::ViewportScrollbarDrag> release_captured_viewport_scrollbar_drag(ContextState&, Gfx::FloatPoint position);
    ...
    void paint_viewport_scrollbar_overlay(ContextState&, Gfx::PaintingSurface&);
    ...
    HashTable<Web::Compositor::CompositorContextId> m_destroyed_context_ids;
