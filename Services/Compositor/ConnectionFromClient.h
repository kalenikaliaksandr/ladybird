...
private:
    ...
    virtual void did_request_cursor_change(Web::Compositor::CompositorContextId, Gfx::Cursor const&) override;

    virtual Messages::CompositorControlServer::ConnectWebContentResponse connect_web_content() override;
    virtual void create_context(Web::Compositor::CompositorContextId, Optional<u64> page_id, Web::Compositor::PagePresentationRegistration) override;
    ...
    virtual void device_pixels_per_css_pixel_updated(Web::Compositor::CompositorContextId, double) override;
    virtual void system_visibility_state_updated(Web::Compositor::CompositorContextId, Web::HTML::VisibilityState) override;
    virtual void window_occlusion_state_updated(Web::Compositor::CompositorContextId, bool is_occluded) override;
    virtual Messages::CompositorControlServer::MouseEventResponse mouse_event(Web::Compositor::CompositorContextId, Web::MouseEvent) override;
    virtual void forward_mouse_event(Web::Compositor::CompositorContextId, Web::MouseEvent) override;
    ...
    Vector<NonnullRefPtr<ConnectionFromWebContent>> m_web_content_connections;
