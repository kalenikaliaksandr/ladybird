...
bool ConnectionFromWebContent::is_context_owned_by_this_connection(Web::Compositor::CompositorContextId context_id)
{
...
{
    if (!is_context_owned_by_this_connection(context_id))
        return;
