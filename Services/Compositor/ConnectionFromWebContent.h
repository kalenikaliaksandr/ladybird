...
private:
    ...
    virtual Messages::CompositorWebContentServer::AsyncScrollByResponse async_scroll_by(Web::Compositor::CompositorContextId, Web::UniqueNodeID document_id, Gfx::FloatPoint position, Gfx::FloatPoint delta, Gfx::IntRect viewport_rect, Web::Compositor::AsyncScrollInput, Web::Compositor::AsyncScrollOperationTracking) override;
    ...
    virtual Messages::CompositorWebContentServer::TakeOverUserScrollResponse take_over_user_scroll(Web::Compositor::CompositorContextId, Web::Compositor::AsyncScrollNodeStableID, Web::Compositor::UserScrollTakeoverReason) override;
