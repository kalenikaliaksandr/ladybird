...
private:
    explicit ConnectionFromWebContent(NonnullOwnPtr<IPC::Transport>, NonnullRefPtr<CompositorState>);
    ...
    virtual void did_request_cursor_change(Web::Compositor::CompositorContextId, Gfx::Cursor) override;
    ...
    virtual void forward_mouse_event(u64 page_id, Web::MouseEvent const&) override;
    virtual void request_rendering_update() override;
    bool set_context_owner(Web::Compositor::CompositorContextId);
