...
private:
    ...
    virtual void webgl_commands(Web::Painting::CanvasId canvas_id, u32 command_buffer_id, u32 command_size, Core::AnonymousBuffer command_buffer, Vector<Gfx::DecodedImageFrame> bitmaps) override;
    virtual Messages::CompositorWebContentServer::WebglWaitForCommandBuffersResponse webgl_wait_for_command_buffers(Web::Painting::CanvasId canvas_id) override;
