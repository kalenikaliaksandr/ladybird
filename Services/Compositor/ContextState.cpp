...
void ContextState::set_canvas_surface(Web::Painting::CanvasId canvas_id, NonnullRefPtr<Gfx::PaintingSurface> surface)
{
    m_display_list_resource_storage.set_canvas_surface(canvas_id, move(surface));
}
