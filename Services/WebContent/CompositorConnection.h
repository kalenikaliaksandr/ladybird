...
public:
    ...
    Optional<Web::Painting::CanvasId> create_webgl_context(Web::WebGL::WebGLVersion, Gfx::IntSize, bool alpha, bool depth, bool stencil, bool antialias, Vector<String>& out_supported_extensions);
