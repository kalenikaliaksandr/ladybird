...
private:
    virtual CreateResult create_context(Web::Painting::CanvasContextId canvas_context_id, Web::WebGL::WebGLVersion webgl_version, Gfx::IntSize initial_size, bool depth, bool stencil, bool antialias) override
    {
        ...
        CreateResult result;
        result.success = m_connection->create_canvas_context(canvas_context_id, { .type = type, .size = initial_size, .depth = depth, .stencil = stencil, .antialias = antialias }, result.supported_extensions);
        return result;
    }
    ...
    virtual Web::WebGL::ReadPixelsResult read_pixels_robust_angle(Web::Painting::CanvasContextId canvas_context_id, Web::WebGL::GLint x, Web::WebGL::GLint y, Web::WebGL::GLsizei width, Web::WebGL::GLsizei height, Web::WebGL::GLenum format, Web::WebGL::GLenum type, Web::WebGL::GLsizei buf_size, Core::AnonymousBuffer pixels) override
    {
        return m_connection->read_webgl_pixels(canvas_context_id, x, y, width, height, format, type, buf_size, pixels);
    }

    virtual void read_buffer_sub_data(Web::Painting::CanvasContextId canvas_context_id, Web::WebGL::GLenum target, Web::WebGL::GLintptr offset, Web::WebGL::GLintptr size, Core::AnonymousBuffer data) override
    {
        m_connection->read_webgl_buffer_sub_data(canvas_context_id, target, offset, size, data);
    }
