...
TEST_CASE(export_bitmap_to_byte_buffer)
{
    ...
    TestData subtests[] = {
        ...
        },
        {
            alpha_bitmap_formats,
            { Premultiplied::No },
            { 0x00112233, 0x7F112233, 0x80112233, 0xFF112233 },
            Gfx::ExportFormat::RGBA5551,
            { Premultiplied::No },
            { 0x0C, 0x11, 0x0C, 0x11, 0x0D, 0x11, 0x0D, 0x11 },
        },
        {
            alpha_bitmap_formats,
            { Premultiplied::No },
            { 0x0055AAFF, 0x3355AAFF, 0x8055AAFF, 0xFF55AAFF },
            Gfx::ExportFormat::RGBA5551,
            { Premultiplied::Yes },
            { 0x00, 0x00, 0x0C, 0x11, 0xA1, 0x2A, 0x7F, 0x55 },
        },
        {
            non_alpha_bitmap_formats,
            { Premultiplied::No, Premultiplied::Yes },
        ...
        },
        {
            ...
            Gfx::ExportFormat::RGB888,
            { Premultiplied::Yes },
            { 0x11, 0x22, 0x33, 0x22, 0x44, 0x66, 0x33, 0x66, 0x99, 0x44, 0x88, 0xCC },
        },
        {
            alpha_bitmap_formats,
            { Premultiplied::Yes },
            ...
            Gfx::ExportFormat::RGB888,
            { Premultiplied::No },
            { 0x55, 0xAA, 0xFF, 0x55, 0xAA, 0xFF, 0x55, 0xAA, 0xFF, 0x55, 0xAA, 0xFF },
        },
        {
            alpha_bitmap_formats,
            { Premultiplied::Yes },
        ...
        },
        {
            alpha_bitmap_formats,
            { Premultiplied::No },
            { 0x00FF00FF, 0x0000FF00, 0x00FF0000, 0x000000FF },
            Gfx::ExportFormat::RGBA8888,
            { Premultiplied::No },
            { 0xFF, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00 },
        },
        {
            alpha_bitmap_formats,
            { Premultiplied::No },
