...
void SVGFormattingContext::layout_svg_element(Box const& child)
{
    if (is<SVG::SVGViewport>(child.dom_node())) {
        ...
        Layout::BlockFormattingContext bfc(m_state.wrapped_state(), LayoutMode::Normal, static_cast<BlockContainer const&>(child), this);
...
void SVGFormattingContext::layout_nested_viewport(Box const& viewport)
{
    ...
    SVGFormattingContext nested_context(m_state.wrapped_state(), LayoutMode::Normal, viewport, this, m_current_viewbox_transform);
...
void SVGFormattingContext::layout_mask_or_clip(SVGBox const& mask_or_clip)
{
    ...
    SVGFormattingContext nested_context(m_state.wrapped_state(), LayoutMode::Normal, mask_or_clip, this, parent_viewbox_transform);
